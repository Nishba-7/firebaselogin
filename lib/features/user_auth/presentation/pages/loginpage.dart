...
import 'package:flutterlogin/features/user_auth/presentation/pages/sign_up_page.dart';
          ...
          GestureDetector(
            onTap:_signIn,
             child: Container(
                ...
                child:  Center(
                  child: _isSighning ? const CircularProgressIndicator(
                    color: Colors.white,
                  ): const Text(
                    "Login",
                    style: TextStyle(
